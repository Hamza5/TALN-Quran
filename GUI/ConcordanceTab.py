...
class Ui_ConcordanceTab(object):
    def setupUi(self, ConcordanceTab):
        ...
        self.gridLayout.addWidget(self.concordanceSourceLineEdit, 0, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.concordanceSourceSelectPushButton, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.concordanceSourceSearchTypesGroupBox, 3, 0, 1, 4)
